...
Emby for Chromecast can handle just about any type of media thanks to [Emby Server transcoding](server/transcoding/Transcoding.md). If you would like to learn how to prepare your media for Direct Play, read below.
...
- **Video**
  MP4, M4V, MKV, WEBM
- **Subtitles**
  SRT and other text-based formats
- **Audio**
  AAC, MP3, WAV, FLAC, OPUS
