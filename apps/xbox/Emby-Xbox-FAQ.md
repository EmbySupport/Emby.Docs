...
- System Settings may take precedence
  To fix this, go to Xbox Accessibiliy settings and look for **Captions**. Disable all settings there.



### The start animation is nice, but it takes a long time and the previous Xbox app was starting up faster, can the animation be disabled?
